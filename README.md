...
<p>Arama yapılacak siteleri güncellemek için programın yanındaki sites.json dosyasını düzenleyebilirsiniz. JSON formatı şu şekildedir:</p>
<p>======================================================</p>
<pre>
{
  "Siteler": [
...
<p>=======================================================</p>
<h2>☕ Destek Ol</h2>
<p>Bu projeyi geliştirmeye devam etmemi istersen veya emeğimi desteklemek istersen beni sosyal medya platformlarından takip edebilirsiniz:</p>
<a href=""></a>
